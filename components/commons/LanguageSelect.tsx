...
import CN from "@/public/assets/images/CNflag.png";
              ...
              >
                <ul className="py-2">
                  <li className=" cursor-pointer px-1 py-1 text-sm hover:bg-gray-100 h-8">
                    <Link href={"/vi-VN"} className="flex items-center">
                  ...
                  <li className="flex items-center cursor-pointer px-1 py-1 text-sm hover:bg-gray-100 h-8">
                    <Link href={"/zh-CN"} className="flex items-center">
                      <Image src={CN} alt="" className="w-4 h-4 mr-3" />
                      CN
                    </Link>
                  </li>
                </ul>
