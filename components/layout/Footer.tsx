        ...
        <Footer style={{ backgroundColor: SystemColor.footerBackground }} className='px-6 '>
            <main className="w-full">
                <div className="mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
      ...
      <main className="w-full">
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            ...
            <div className="lg:mx-auto text-left ">
              <h4 className="text-xl text-maintext font-bold uppercase mb-7 tracking-wider">
                Instruments
              </h4>
              <ul className="text-lg  transition-all duration-500 text-white">
                <li className="mb-6">
                  <a className="hover:text-maintext">Forex</a>
                </li>
                <li className="mb-6">
                  <a className="hover:text-maintext">Indices</a>
                </li>
                <li className="mb-6">
                  <a className="hover:text-maintext">Precious Metals</a>
                </li>
                <li className="mb-6">
                  <a className="hover:text-maintext">Energy</a>
                </li>
                <li>
                  <a className="hover:text-maintext">Cryptocurrency</a>
                </li>
              </ul>
            </div>
            ...
            <div className="lg:mx-auto text-left ">
              ...
              <ul className="text-lg  transition-all duration-500 text-white">
                <li className="mb-6">
                  <a className="hover:text-maintext">Type of Account</a>
                </li>
                <li>
                  <a className="hover:text-maintext">Contract details</a>
                </li>
              </ul>
            </div>
            ...
            <div className="lg:mx-auto text-left">
              ...
              <ul className="text-lg  transition-all duration-500 text-white">
                <li className="mb-6">
                  <a className="hover:text-maintext">Why Choose Us</a>
                </li>
                <li className="mb-6">
                  <a className="hover:text-maintext">Help Center</a>
                </li>
                <li className="mb-6">
                  <a className="hover:text-maintext">Latest Announcements</a>
                </li>
                <li>
                  <a className="hover:text-maintext">Market Trend</a>
                </li>
              </ul>
            </div>
            ...
            <div className="lg:mx-auto text-left">
              ...
              <ul className="text-lg transition-all duration-500 text-white">
                <li className="mb-6">
                  <a className="hover:text-maintext">Open a Real Account</a>
                </li>
                <li>
                  <a className="hover:text-maintext">
                    Experience Simulation Trading
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span className="text-lg text-white">
                ©
                <a href="/" className="text-maintext font-medium">
                  Smartfinance
                </a>{" "}
