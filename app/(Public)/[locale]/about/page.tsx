...
export default function AboutPage() {
  ...
  return (
    ...
    <div style={{ backgroundColor: SystemColor.grayBackground }} key='about' className='text-white bg-cover bg-center w-full flex flex-col items-center mb-30'
    >
      <div className='my-16'>
      </div>
        ...
        <div className='col-span-2'>
          <div className='h-full flex items-center justify-center'>
            <div className='w-full'>
              ...
              <p className='font-bold text-xl my-5'>{t('TextStartAtAboutPage')}</p>
